  ...
  return (
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-background/50 backdrop-blur-sm border border-border/30 rounded-2xl p-8">
              ...
              <motion.div variants={containerVariants} className="space-y-4">
                {awards.map((award, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <h4 className="text-lg font-semibold text-foreground mb-2 group-hover:text-foreground/80 transition-colors">
                          {award.title}
                        </h4>
                        <div className="flex items-center text-muted-foreground mb-2">
                        ...
                        <div className="inline-flex items-center px-3 py-1 bg-foreground/10 text-foreground text-xs font-medium rounded-full">
                          <Trophy className="w-3 h-3 mr-1 text-foreground" />
                          Finalist
                        </div>
                      </div>
                      <div className="ml-4">
